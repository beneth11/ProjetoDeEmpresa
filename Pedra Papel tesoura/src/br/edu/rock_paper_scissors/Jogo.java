 ...
 */
package br.edu.rock_paper_scissors;
...
public class Jogo extends javax.swing.JFrame {
    ...
    // images path
    String rock = "/br/edu/images/rock.png";
    String paper = "/br/edu/images/paper.png";
    String scissors = "/br/edu/images/scissors.png";
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(128, 15, 161));

        jLabel_You.setBackground(new java.awt.Color(102, 0, 0));
        jLabel_You.setOpaque(true);

        jLabel_Computer.setBackground(new java.awt.Color(0, 153, 153));
